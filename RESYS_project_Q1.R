...
macrophage2 <- c("JUN", "IRF1", "IRF5", 
                "IRF7", "IRF8", "MKI67", "MNDA", "NFKB1", "PCNA", 
                "PPARG", "SPI1", "STAT1", "STAT3")
macrophage2 <- mapIds(org.Hs.eg.db, macrophage2, "ENTREZID", "SYMBOL")
...
rtni_macro <- tni.constructor(expData = as.matrix(exEntrez),
                              regulatoryElements = macrophage2,
...
# Plot GSEA-2T results
tna.plot.gsea2(rtna_Bcell, labPheno="log2 fold changes", tfs="BACH2",
